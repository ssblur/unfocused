...
object ColorHelper {
  ...
  fun RegistrySupplier<Block>.registerColor(color: BlockTintSource) = registerColor(color, this)
  fun Block.registerColor(color: BlockTintSource) = registerColor(color, { this })
}